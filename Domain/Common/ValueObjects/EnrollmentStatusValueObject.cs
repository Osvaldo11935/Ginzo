...
public static class EnrollmentStatusValueObject
{
    ...
    public static string PreApprovedName = "Pre-Aprovado";
    ...
    public static string PreApprovedId = "81a9dcce-3aaf-4a56-b429-73854eb25cf2";
    ...
    public static List<EnrollmentStatus> AddEnrollmentStatus()
    {
        return new List<EnrollmentStatus>()
        {
            ...
            {
                Id = PreApprovedId,
                Status = PreApprovedName,
                Description = PreApprovedName
            }
        };
    }
}